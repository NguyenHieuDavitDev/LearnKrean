...
export const QA_CATEGORIES: {
  ...
  { id: 'offtopic', label: 'Chủ đề ngoài khóa học', icon: faCircleQuestion },
...
export const QA_QUESTIONS: QaQuestion[] = [
  ...
  {
    id: 7,
    title: 'Video bài Speaking Pro bị đứng ở phút 08:12 trên iPhone',
    author: 'Đức Huy',
...
> = {
  ...
  7: {
    content:
      'Dạ hiện tại khi em xem video Speaking Pro trên iPhone thì bị đứng ở phút 08:12, không tua được tiếp. Em thử Safari và Chrome đều vậy ạ.',
    lesson: 'Speaking Pro — Bài 12 Hội thoại cà phê',
